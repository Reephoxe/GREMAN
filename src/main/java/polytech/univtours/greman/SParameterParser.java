    ...
    /*public static void main(String[] args) {
        try {
            ...
            for (DataPoint dp : dataPoints) {
                String f = String.valueOf(dp.frequence);
                String Z = dp.impedanceReel + " + " + dp.impedanceImaginaire + "i";
                String[] resultat = Executable.ScriptTotal(f, Z, "4", "2", "7", "4.05");

                System.out.println("Résultats pour " + dp.frequence + " Hz :");
